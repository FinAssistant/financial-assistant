...
- [ ] Add completion state tracking requiring Plaid account linking
  - [ ] Update profile completion logic to require connected accounts via Plaid
  - [ ] Implement user.profile_complete = True only after account linking succeeds
...
- PUT /api/profile/personal-context - Update user's PersonalContext data
